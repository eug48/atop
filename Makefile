...
#CFLAGS  += -g -I. -Wall  # -DNOPERFEVENT   # -DHTTPSTATS
OBJMOD0  = version.o
OBJMOD1  = various.o  deviate.o   procdbase.o
OBJMOD2  = acctproc.o photoproc.o photoprocall.o photosyst.o  rawlog.o ifprop.o parseable.o
...
photoprocall.o:	atop.h	photoproc.h
